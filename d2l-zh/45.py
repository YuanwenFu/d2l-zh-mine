...
def func2():
    ...
    concat_preds = concat_pred([Y1, Y2])
    ...
    def display(img, output, threshold):
        ...
        d2l.plt.savefig("banana_detection_result.png", bbox_inches='tight')
...
def func3():
    ...
    QA
    """
    #分辨率特别大的图片，不适合用SSD算法，因为锚框太多了。反而Faster R-CNN算法更适合。
    #或者尼克一考虑yolo，不管你的图像尺寸，它的锚框数都差不多。
    #每个feature map上的像素做多个锚框。
    #语义分割会讲对土壤的检测。
    return
