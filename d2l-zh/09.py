...
def func3():
    ...
    def show_images(imgs, num_rows, num_cols, titles=None, scale=1.5):
        ...
        #保存图像
        d2l.plt.savefig("fashion_mnist_plot.png")
        return axes 
...
def func4():
    ...
    if True:
        ...
        X_prob = softmax(X)
        print(f"X_prob: {X_prob}, X_prob.sum(1): {X_prob.sum(1)}")
    print(f"X: {X}")
    ...
    def predict_ch3(net, test_iter, n=6):
        ...
        # 保存图像
        d2l.plt.savefig("predictions_ch3.png", dpi=150, bbox_inches='tight')
        print(f"图像已保存为: predictions_ch3.png")
